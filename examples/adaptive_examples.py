...
def example_adaptive_recommendations(course_code: str = "B006802", core_loop_name: str = None):
    ...
    try:
        ...
        console.print(f"📖 Show Prerequisites: {'Yes' if recommendations['show_prerequisites'] else 'No'}")
...
if __name__ == "__main__":
    ...
    console.print("[dim]To run the other examples, uncomment them and provide a valid course code.[/dim]\n")
